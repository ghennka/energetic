    ...
    $stateProvider.state('app', {
      ...
      .state('app.forms', {
        ...
        resolve: {
          deps: ['$ocLazyLoad', function($ocLazyLoad) {
            return $ocLazyLoad.load([{
              files: ['scripts/helpers/classie.js', 'scripts/helpers/inputfx.js', 'scripts/helpers/selectfx.js']
            }]);
          }]
        }
        ...
        resolve: {
          deps: ['$ocLazyLoad', function($ocLazyLoad) {
            return $ocLazyLoad.load([{
              ...
              serie: true,
              files: ['vendor/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.js', 'vendor/chosen_v1.4.0/chosen.jquery.min.js', 'vendor/jquery.tagsinput/src/jquery.tagsinput.js', 'vendor/checkbo/src/0.1.4/js/checkBo.min.js', 'vendor/intl-tel-input//build/js/intlTelInput.min.js', 'vendor/moment/min/moment.min.js', 'vendor/bootstrap-daterangepicker/daterangepicker.js', 'vendor/bootstrap-datepicker/dist/js/bootstrap-datepicker.js', 'vendor/bootstrap-timepicker/js/bootstrap-timepicker.min.js', 'vendor/clockpicker/dist/jquery-clockpicker.min.js', 'vendor/mjolnic-bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js', 'vendor/jquery-labelauty/source/jquery-labelauty.js', 'vendor/bootstrap-maxlength/bootstrap-maxlength.min.js', 'vendor/typeahead.js/dist/typeahead.bundle.js', 'vendor/multiselect/js/jquery.multi-select.js']
            }, {
              name: 'ui.select2',
      ...
      .state('app.tables', {
        ...
        resolve: {
          deps: ['$ocLazyLoad', function($ocLazyLoad) {
            return $ocLazyLoad.load([{
              insertBefore: '#load_styles_before',
              files: ['vendor/chosen_v1.4.0/chosen.min.css', 'vendor/datatables/media/css/jquery.dataTables.css']
            }, {
              serie: true,
              files: ['vendor/chosen_v1.4.0/chosen.jquery.min.js', 'vendor/datatables/media/js/jquery.dataTables.js', 'scripts/helpers/bootstrap-datatables.js']
            }]).then(function() {
      ...
      .state('app.charts', {
        ...
        resolve: {
          deps: ['$ocLazyLoad', function($ocLazyLoad) {
            return $ocLazyLoad.load([{
              insertBefore: '#load_styles_before',
              files: ['vendor/nvd3/nv.d3.min.css']
            }, {
              name: 'nvd3',
              serie: true,
              files: ['vendor/d3/d3.min.js', 'vendor/nvd3/nv.d3.min.js', 'vendor/angular-nvd3/dist/angular-nvd3.js']
            }]).then(function() {
